...
PACKED_STRUCT(SeeSpotControlReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationInitCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationInitReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationPropertiesCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationStatusReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(PlatformNavigationDataAccuracyCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(PlatformNavigationDataCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(PlatformNavigationDataReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationIMUDataReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(GPSDataReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationRecordCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(GPSRecordingReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(NavigationBITReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorStatusReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorFireCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorFireReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorNATOCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(DesignatorNATOReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(IlluminatorCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(IlluminatorReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(IlluminatorFireCommandStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
PACKED_STRUCT(IlluminatorFireReportStruct) 
{
	uint16_t KeyID;
	uint8_t Length;
	uint8_t SubMessageID;
...
struct SeeSpotControlReportStruct SeeSpotControlReport_obj;
...
struct NavigationInitCommandStruct NavigationInitCommand_obj;
struct NavigationInitReportStruct NavigationInitReport_obj;
struct NavigationPropertiesCommandStruct NavigationPropertiesCommand_obj;
struct NavigationStatusReportStruct NavigationStatusReport_obj;
struct PlatformNavigationDataAccuracyCommandStruct PlatformNavigationDataAccuracyCommand_obj;
struct PlatformNavigationDataCommandStruct PlatformNavigationDataCommand_obj;
struct PlatformNavigationDataReportStruct PlatformNavigationDataReport_obj;
struct NavigationIMUDataReportStruct NavigationIMUDataReport_obj;
struct GPSDataReportStruct GPSDataReport_obj;
struct NavigationRecordCommandStruct NavigationRecordCommand_obj;
struct GPSRecordingReportStruct GPSRecordingReport_obj;
struct NavigationBITReportStruct NavigationBITReport_obj;
struct DesignatorCommandStruct DesignatorCommand_obj;
struct DesignatorStatusReportStruct DesignatorStatusReport_obj;
struct DesignatorFireCommandStruct DesignatorFireCommand_obj;
struct DesignatorFireReportStruct DesignatorFireReport_obj;
struct DesignatorNATOCommandStruct DesignatorNATOCommand_obj;
struct DesignatorNATOReportStruct DesignatorNATOReport_obj;
struct IlluminatorCommandStruct IlluminatorCommand_obj;
struct IlluminatorReportStruct IlluminatorReport_obj;
struct IlluminatorFireCommandStruct IlluminatorFireCommand_obj;
struct IlluminatorFireReportStruct IlluminatorFireReport_obj;
...
SeeSpotControlReport_obj.KeyID = 35400;
SeeSpotControlReport_obj.Length = 20;
SeeSpotControlReport_obj.SubMessageID = 0;
...
NavigationInitCommand_obj.KeyID = 7015;
NavigationInitCommand_obj.Length = 22;
NavigationInitCommand_obj.SubMessageID = 0;

NavigationInitReport_obj.KeyID = 37015;
NavigationInitReport_obj.Length = 22;
NavigationInitReport_obj.SubMessageID = 0;

NavigationPropertiesCommand_obj.KeyID = 7000;
NavigationPropertiesCommand_obj.Length = 5;
NavigationPropertiesCommand_obj.SubMessageID = 0;

NavigationStatusReport_obj.KeyID = 37000;
NavigationStatusReport_obj.Length = 34;
NavigationStatusReport_obj.SubMessageID = 0;

PlatformNavigationDataAccuracyCommand_obj.KeyID = 7010;
PlatformNavigationDataAccuracyCommand_obj.Length = 6;
PlatformNavigationDataAccuracyCommand_obj.SubMessageID = 0;

PlatformNavigationDataCommand_obj.KeyID = 7011;
PlatformNavigationDataCommand_obj.Length = 34;
PlatformNavigationDataCommand_obj.SubMessageID = 0;

PlatformNavigationDataReport_obj.KeyID = 37011;
PlatformNavigationDataReport_obj.Length = 46;
PlatformNavigationDataReport_obj.SubMessageID = 0;

NavigationIMUDataReport_obj.KeyID = 37050;
NavigationIMUDataReport_obj.Length = 39;
NavigationIMUDataReport_obj.SubMessageID = 0;

GPSDataReport_obj.KeyID = 37801;
GPSDataReport_obj.Length = 28;
GPSDataReport_obj.SubMessageID = 0;

NavigationRecordCommand_obj.KeyID = 7017;
NavigationRecordCommand_obj.Length = 5;
NavigationRecordCommand_obj.SubMessageID = 0;

GPSRecordingReport_obj.KeyID = 37017;
GPSRecordingReport_obj.Length = 9;
GPSRecordingReport_obj.SubMessageID = 0;

NavigationBITReport_obj.KeyID = 37010;
NavigationBITReport_obj.Length = 5;
NavigationBITReport_obj.SubMessageID = 0;

DesignatorCommand_obj.KeyID = 8450;
DesignatorCommand_obj.Length = 8;
DesignatorCommand_obj.SubMessageID = 0;

DesignatorStatusReport_obj.KeyID = 38450;
DesignatorStatusReport_obj.Length = 8;
DesignatorStatusReport_obj.SubMessageID = 0;

DesignatorFireCommand_obj.KeyID = 8451;
DesignatorFireCommand_obj.Length = 8;
DesignatorFireCommand_obj.SubMessageID = 0;

DesignatorFireReport_obj.KeyID = 38451;
DesignatorFireReport_obj.Length = 8;
DesignatorFireReport_obj.SubMessageID = 0;

DesignatorNATOCommand_obj.KeyID = 8455;
DesignatorNATOCommand_obj.Length = 6;
DesignatorNATOCommand_obj.SubMessageID = 0;

DesignatorNATOReport_obj.KeyID = 38455;
DesignatorNATOReport_obj.Length = 6;
DesignatorNATOReport_obj.SubMessageID = 0;

IlluminatorCommand_obj.KeyID = 8500;
IlluminatorCommand_obj.Length = 6;
IlluminatorCommand_obj.SubMessageID = 0;

IlluminatorReport_obj.KeyID = 38500;
IlluminatorReport_obj.Length = 6;
IlluminatorReport_obj.SubMessageID = 0;

IlluminatorFireCommand_obj.KeyID = 8501;
IlluminatorFireCommand_obj.Length = 8;
IlluminatorFireCommand_obj.SubMessageID = 0;

IlluminatorFireReport_obj.KeyID = 38501;
IlluminatorFireReport_obj.Length = 8;
IlluminatorFireReport_obj.SubMessageID = 0;
...
int udp_init(SOCKET *sockfd) {
    ...
    // Allow immediate rebind to LOCAL_PORT after a quick app restart, before
    // Windows would otherwise still consider the previous process's socket
    // to hold it -- without this, bind() below can fail with WSAEADDRINUSE
    // and camera control silently stops working until the OS times it out.
    BOOL reuse = TRUE;
...
int STKInitializeCommunication(struct MessagesTransmitEnableStruct data)
{
    ...
    MessagesTransmitEnable.EnableTXNavigationInitCommand = data.EnableTXNavigationInitCommand ;
    MessagesTransmitEnable.EnableTXNavigationPropertiesCommand = data.EnableTXNavigationPropertiesCommand ;
    MessagesTransmitEnable.EnableTXPlatformNavigationDataAccuracyCommand = data.EnableTXPlatformNavigationDataAccuracyCommand ;
    MessagesTransmitEnable.EnableTXPlatformNavigationDataCommand = data.EnableTXPlatformNavigationDataCommand ;
    MessagesTransmitEnable.EnableTXNavigationRecordCommand = data.EnableTXNavigationRecordCommand ;
    MessagesTransmitEnable.EnableTXDesignatorCommand = data.EnableTXDesignatorCommand ;
    MessagesTransmitEnable.EnableTXDesignatorFireCommand = data.EnableTXDesignatorFireCommand ;
    MessagesTransmitEnable.EnableTXDesignatorNATOCommand = data.EnableTXDesignatorNATOCommand ;
    MessagesTransmitEnable.EnableTXIlluminatorCommand = data.EnableTXIlluminatorCommand ;
    MessagesTransmitEnable.EnableTXIlluminatorFireCommand = data.EnableTXIlluminatorFireCommand ;
        ...
        else
        {
            switch (TempMsgId)
            {
                ...
                case 35700:
                    ...
                    break;
                case 35400:
                    memcpy(&SeeSpotControlReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(SeeSpotControlReport_obj);
                    break;
                case 35999:
                ...
                case 36561:
                    ...
                    break;
                case 37015:
                    memcpy(&NavigationInitReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(NavigationInitReport_obj);
                    break;
                case 37000:
                    memcpy(&NavigationStatusReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(NavigationStatusReport_obj);
                    break;
                case 37011:
                    memcpy(&PlatformNavigationDataReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(PlatformNavigationDataReport_obj);
                    break;
                case 37050:
                    memcpy(&NavigationIMUDataReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(NavigationIMUDataReport_obj);
                    break;
                case 37801:
                    memcpy(&GPSDataReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(GPSDataReport_obj);
                    break;
                case 37017:
                    memcpy(&GPSRecordingReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(GPSRecordingReport_obj);
                    break;
                case 37010:
                    memcpy(&NavigationBITReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(NavigationBITReport_obj);
                    break;
                case 38450:
                    memcpy(&DesignatorStatusReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(DesignatorStatusReport_obj);
                    break;
                case 38451:
                    memcpy(&DesignatorFireReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(DesignatorFireReport_obj);
                    break;
                case 38455:
                    memcpy(&DesignatorNATOReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(DesignatorNATOReport_obj);
                    break;
                case 38500:
                    memcpy(&IlluminatorReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(IlluminatorReport_obj);
                    break;
                case 38501:
                    memcpy(&IlluminatorFireReport_obj, &RXBuff[idx], TempMsgSize );
                    BufSize=sizeof(IlluminatorFireReport_obj);
                    break;
                case 50901:
...
if (MessagesTransmitEnable.EnableTXNavigationInitCommand)
    {
        memcpy((ptr + idx), &NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
        idx += sizeof(NavigationInitCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXNavigationPropertiesCommand)
    {
        memcpy((ptr + idx), &NavigationPropertiesCommand_obj, sizeof(NavigationPropertiesCommand_obj));
        idx += sizeof(NavigationPropertiesCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXPlatformNavigationDataAccuracyCommand)
    {
        memcpy((ptr + idx), &PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
        idx += sizeof(PlatformNavigationDataAccuracyCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXPlatformNavigationDataCommand)
    {
        memcpy((ptr + idx), &PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
        idx += sizeof(PlatformNavigationDataCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXNavigationRecordCommand)
    {
        memcpy((ptr + idx), &NavigationRecordCommand_obj, sizeof(NavigationRecordCommand_obj));
        idx += sizeof(NavigationRecordCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXDesignatorCommand)
    {
        memcpy((ptr + idx), &DesignatorCommand_obj, sizeof(DesignatorCommand_obj));
        idx += sizeof(DesignatorCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXDesignatorFireCommand)
    {
        memcpy((ptr + idx), &DesignatorFireCommand_obj, sizeof(DesignatorFireCommand_obj));
        idx += sizeof(DesignatorFireCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXDesignatorNATOCommand)
    {
        memcpy((ptr + idx), &DesignatorNATOCommand_obj, sizeof(DesignatorNATOCommand_obj));
        idx += sizeof(DesignatorNATOCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXIlluminatorCommand)
    {
        memcpy((ptr + idx), &IlluminatorCommand_obj, sizeof(IlluminatorCommand_obj));
        idx += sizeof(IlluminatorCommand_obj);
    }
if (MessagesTransmitEnable.EnableTXIlluminatorFireCommand)
    {
        memcpy((ptr + idx), &IlluminatorFireCommand_obj, sizeof(IlluminatorFireCommand_obj));
        idx += sizeof(IlluminatorFireCommand_obj);
    }
...
{
	DayCameraSetFOV_obj.SetFOVCommand = SetFOVCommand;
...
{
	TICameraSetFOV_obj.SetFOVCommand = SetFOVCommand;
...
/*----- SeeSpotControlReport 35400 -----*/
bool GetSeeSpotControlReportPower()
{
	return SeeSpotControlReport_obj.Power;
}

bool GetSeeSpotControlReportFreeze()
{
	return SeeSpotControlReport_obj.Freeze;
}
...
/*----- NavigationInitCommand 7015 -----*/
int SetNavigationInitCommandXMountingAngle(int16_t XMountingAngle)
{
	NavigationInitCommand_obj.XMountingAngle = XMountingAngle & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandYMountingAngle(int16_t YMountingAngle)
{
	NavigationInitCommand_obj.YMountingAngle = YMountingAngle & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandZMountingAngle(int16_t ZMountingAngle)
{
	NavigationInitCommand_obj.ZMountingAngle = ZMountingAngle & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandLeverArmX(int16_t LeverArmX)
{
	NavigationInitCommand_obj.LeverArmX = LeverArmX & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandLeverArmY(int16_t LeverArmY)
{
	NavigationInitCommand_obj.LeverArmY = LeverArmY & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandLeverArmZ(int16_t LeverArmZ)
{
	NavigationInitCommand_obj.LeverArmZ = LeverArmZ & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandPlatformBodyAzimuth(int16_t PlatformBodyAzimuth)
{
	NavigationInitCommand_obj.PlatformBodyAzimuth = PlatformBodyAzimuth & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandPlatformBodyPitch(int16_t PlatformBodyPitch)
{
	NavigationInitCommand_obj.PlatformBodyPitch = PlatformBodyPitch & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}

int SetNavigationInitCommandPlatformBodyRoll(int16_t PlatformBodyRoll)
{
	NavigationInitCommand_obj.PlatformBodyRoll = PlatformBodyRoll & 0xffff;
	return SendData(&NavigationInitCommand_obj, sizeof(NavigationInitCommand_obj));
}


/*----- NavigationInitReport 37015 -----*/
int16_t GetNavigationInitReportXMountingAngle()
{
	return NavigationInitReport_obj.XMountingAngle;
}

int16_t GetNavigationInitReportYMountingAngle()
{
	return NavigationInitReport_obj.YMountingAngle;
}

int16_t GetNavigationInitReportZMountingAngle()
{
	return NavigationInitReport_obj.ZMountingAngle;
}

int16_t GetNavigationInitReportLeverArmX()
{
	return NavigationInitReport_obj.LeverArmX;
}

int16_t GetNavigationInitReportLeverArmY()
{
	return NavigationInitReport_obj.LeverArmY;
}

int16_t GetNavigationInitReportLeverArmZ()
{
	return NavigationInitReport_obj.LeverArmZ;
}

int16_t GetNavigationInitReportPlatformBodyAzimuth()
{
	return NavigationInitReport_obj.PlatformBodyAzimuth;
}

int16_t GetNavigationInitReportPlatformBodyPitch()
{
	return NavigationInitReport_obj.PlatformBodyPitch;
}

int16_t GetNavigationInitReportPlatformBodyRoll()
{
	return NavigationInitReport_obj.PlatformBodyRoll;
}


/*----- NavigationPropertiesCommand 7000 -----*/
int SetNavigationPropertiesCommandPlatformDataSource(int8_t PlatformDataSource)
{
	NavigationPropertiesCommand_obj.PlatformDataSource = PlatformDataSource & 0x3;
	return SendData(&NavigationPropertiesCommand_obj, sizeof(NavigationPropertiesCommand_obj));
}

int SetNavigationPropertiesCommandUsePlatformData(bool UsePlatformData)
{
	NavigationPropertiesCommand_obj.UsePlatformData = UsePlatformData & 0x1;
	return SendData(&NavigationPropertiesCommand_obj, sizeof(NavigationPropertiesCommand_obj));
}

int SetNavigationPropertiesCommandNavigationType(enum NavigationType NavigationType)
{
	NavigationPropertiesCommand_obj.NavigationType = NavigationType;
	return SendData(&NavigationPropertiesCommand_obj, sizeof(NavigationPropertiesCommand_obj));
}

int SetNavigationPropertiesCommandAltitudeType(enum NavAltituteType AltitudeType)
{
	NavigationPropertiesCommand_obj.AltitudeType = AltitudeType;
	return SendData(&NavigationPropertiesCommand_obj, sizeof(NavigationPropertiesCommand_obj));
}


/*----- NavigationStatusReport 37000 -----*/
int8_t GetNavigationStatusReportPlatformDataSource()
{
	return NavigationStatusReport_obj.PlatformDataSource;
}

bool GetNavigationStatusReportUsePlatformData()
{
	return NavigationStatusReport_obj.UsePlatformData;
}

enum NavigationType GetNavigationStatusReportNavigationType()
{
	return NavigationStatusReport_obj.NavigationType;
}

enum NavAltituteType GetNavigationStatusReportAltitudeType()
{
	return NavigationStatusReport_obj.AltitudeType;
}


/*----- PlatformNavigationDataAccuracyCommand 7010 -----*/
int SetPlatformNavigationDataAccuracyCommandPositionAccuracy(int8_t PositionAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.PositionAccuracy = PositionAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}

int SetPlatformNavigationDataAccuracyCommandAltitudeAccuracy(int8_t AltitudeAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.AltitudeAccuracy = AltitudeAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}

int SetPlatformNavigationDataAccuracyCommandAttitudeAccuracy(int8_t AttitudeAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.AttitudeAccuracy = AttitudeAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}

int SetPlatformNavigationDataAccuracyCommandAzimuthAccuracy(int8_t AzimuthAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.AzimuthAccuracy = AzimuthAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}

int SetPlatformNavigationDataAccuracyCommandVelocityAccuracy(int8_t VelocityAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.VelocityAccuracy = VelocityAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}

int SetPlatformNavigationDataAccuracyCommandRateofClimbAccuracy(int8_t RateofClimbAccuracy)
{
	PlatformNavigationDataAccuracyCommand_obj.RateofClimbAccuracy = RateofClimbAccuracy & 0x3;
	return SendData(&PlatformNavigationDataAccuracyCommand_obj, sizeof(PlatformNavigationDataAccuracyCommand_obj));
}


/*----- PlatformNavigationDataCommand 7011 -----*/
int SetPlatformNavigationDataCommandTimeTag(int32_t TimeTag)
{
	PlatformNavigationDataCommand_obj.TimeTag = TimeTag & 0xffffffff;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformLongitude(float PlatformLongitude)
{
	PlatformNavigationDataCommand_obj.PlatformLongitude = PlatformLongitude;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformLatitude(float PlatformLatitude)
{
	PlatformNavigationDataCommand_obj.PlatformLatitude = PlatformLatitude;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformAltitude(float PlatformAltitude)
{
	PlatformNavigationDataCommand_obj.PlatformAltitude = PlatformAltitude;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformBodyAzimuth(float PlatformBodyAzimuth)
{
	PlatformNavigationDataCommand_obj.PlatformBodyAzimuth = PlatformBodyAzimuth;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformBodyPitch(float PlatformBodyPitch)
{
	PlatformNavigationDataCommand_obj.PlatformBodyPitch = PlatformBodyPitch;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandPlatformBodyRoll(float PlatformBodyRoll)
{
	PlatformNavigationDataCommand_obj.PlatformBodyRoll = PlatformBodyRoll;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandGroundSpeed(int8_t GroundSpeed)
{
	PlatformNavigationDataCommand_obj.GroundSpeed = GroundSpeed & 0xff;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}

int SetPlatformNavigationDataCommandRateofClimb(int8_t RateofClimb)
{
	PlatformNavigationDataCommand_obj.RateofClimb = RateofClimb & 0xff;
	return SendData(&PlatformNavigationDataCommand_obj, sizeof(PlatformNavigationDataCommand_obj));
}


/*----- PlatformNavigationDataReport 37011 -----*/
int32_t GetPlatformNavigationDataReportTimeTag()
{
	return PlatformNavigationDataReport_obj.TimeTag;
}

float GetPlatformNavigationDataReportPlatformLongitude()
{
	return PlatformNavigationDataReport_obj.PlatformLongitude;
}

float GetPlatformNavigationDataReportPlatformLatitude()
{
	return PlatformNavigationDataReport_obj.PlatformLatitude;
}

float GetPlatformNavigationDataReportPlatformAltitude()
{
	return PlatformNavigationDataReport_obj.PlatformAltitude;
}

float GetPlatformNavigationDataReportLOSAzimuth()
{
	return PlatformNavigationDataReport_obj.LOSAzimuth;
}

float GetPlatformNavigationDataReportLOSPitch()
{
	return PlatformNavigationDataReport_obj.LOSPitch;
}

float GetPlatformNavigationDataReportLOSRoll()
{
	return PlatformNavigationDataReport_obj.LOSRoll;
}

float GetPlatformNavigationDataReportTargetLongitude()
{
	return PlatformNavigationDataReport_obj.TargetLongitude;
}

float GetPlatformNavigationDataReportTargetLatitude()
{
	return PlatformNavigationDataReport_obj.TargetLatitude;
}

float GetPlatformNavigationDataReportTargetAltitude()
{
	return PlatformNavigationDataReport_obj.TargetAltitude;
}

int8_t GetPlatformNavigationDataReportGroundSpeed()
{
	return PlatformNavigationDataReport_obj.GroundSpeed;
}

int8_t GetPlatformNavigationDataReportRateofClimb()
{
	return PlatformNavigationDataReport_obj.RateofClimb;
}


/*----- NavigationIMUDataReport 37050 -----*/
int64_t GetNavigationIMUDataReportIMUTimeTag()
{
	return NavigationIMUDataReport_obj.IMUTimeTag;
}

int32_t GetNavigationIMUDataReportIMUXRate()
{
	return NavigationIMUDataReport_obj.IMUXRate;
}

int32_t GetNavigationIMUDataReportIMUYRate()
{
	return NavigationIMUDataReport_obj.IMUYRate;
}

int32_t GetNavigationIMUDataReportIMUZRate()
{
	return NavigationIMUDataReport_obj.IMUZRate;
}

int32_t GetNavigationIMUDataReportIMUXAcc()
{
	return NavigationIMUDataReport_obj.IMUXAcc;
}

int32_t GetNavigationIMUDataReportIMUYAcc()
{
	return NavigationIMUDataReport_obj.IMUYAcc;
}

int32_t GetNavigationIMUDataReportIMUZAcc()
{
	return NavigationIMUDataReport_obj.IMUZAcc;
}

int8_t GetNavigationIMUDataReportIMUTemperature()
{
	return NavigationIMUDataReport_obj.IMUTemperature;
}

int16_t GetNavigationIMUDataReportIMUStatus()
{
	return NavigationIMUDataReport_obj.IMUStatus;
}


/*----- GPSDataReport 37801 -----*/
int32_t GetGPSDataReportLongitude()
{
	return GPSDataReport_obj.Longitude;
}

int32_t GetGPSDataReportLatitude()
{
	return GPSDataReport_obj.Latitude;
}

int32_t GetGPSDataReportAltitude()
{
	return GPSDataReport_obj.Altitude;
}

int16_t GetGPSDataReportAzimuth()
{
	return GPSDataReport_obj.Azimuth;
}

uint32_t GetGPSDataReportSecond()
{
	return GPSDataReport_obj.Second;
}

uint32_t GetGPSDataReportmilliseconds()
{
	return GPSDataReport_obj.milliseconds;
}

int8_t GetGPSDataReportNumerOfSatellites()
{
	return GPSDataReport_obj.NumerOfSatellites;
}

bool GetGPSDataReportPositionValid()
{
	return GPSDataReport_obj.PositionValid;
}


/*----- NavigationRecordCommand 7017 -----*/
int SetNavigationRecordCommandRecordLevel(int8_t RecordLevel)
{
	NavigationRecordCommand_obj.RecordLevel = RecordLevel & 0xff;
	return SendData(&NavigationRecordCommand_obj, sizeof(NavigationRecordCommand_obj));
}


/*----- GPSRecordingReport 37017 -----*/
int8_t GetGPSRecordingReportGPSRecordingLevel()
{
	return GPSRecordingReport_obj.GPSRecordingLevel;
}

int32_t GetGPSRecordingReportGPSFreeMemory()
{
	return GPSRecordingReport_obj.GPSFreeMemory;
}


/*----- NavigationBITReport 37010 -----*/
bool GetNavigationBITReportNavigationaccuracyWarning()
{
	return NavigationBITReport_obj.NavigationaccuracyWarning;
}

bool GetNavigationBITReportGPSCommFail()
{
	return NavigationBITReport_obj.GPSCommFail;
}

bool GetNavigationBITReportGPSprecisionFail()
{
	return NavigationBITReport_obj.GPSprecisionFail;
}

bool GetNavigationBITReportGPSantennaFail()
{
	return NavigationBITReport_obj.GPSantennaFail;
}

bool GetNavigationBITReportIMUFail()
{
	return NavigationBITReport_obj.IMUFail;
}

bool GetNavigationBITReportPPSFail()
{
	return NavigationBITReport_obj.PPSFail;
}

bool GetNavigationBITReportCalibrationFail()
{
	return NavigationBITReport_obj.CalibrationFail;
}


/*----- DesignatorCommand 8450 -----*/
int SetDesignatorCommandPower(bool Power)
{
	DesignatorCommand_obj.Power = Power & 0x1;
	return SendData(&DesignatorCommand_obj, sizeof(DesignatorCommand_obj));
}

int SetDesignatorCommandArm(bool Arm)
{
	DesignatorCommand_obj.Arm = Arm & 0x1;
	return SendData(&DesignatorCommand_obj, sizeof(DesignatorCommand_obj));
}


/*----- DesignatorStatusReport 38450 -----*/
bool GetDesignatorStatusReportPower()
{
	return DesignatorStatusReport_obj.Power;
}

bool GetDesignatorStatusReportArm()
{
	return DesignatorStatusReport_obj.Arm;
}

bool GetDesignatorStatusReportReady()
{
	return DesignatorStatusReport_obj.Ready;
}

bool GetDesignatorStatusReportSafetySwitch()
{
	return DesignatorStatusReport_obj.SafetySwitch;
}

bool GetDesignatorStatusReportEnable()
{
	return DesignatorStatusReport_obj.Enable;
}


/*----- DesignatorFireCommand 8451 -----*/
int SetDesignatorFireCommandFire(bool Fire)
{
	DesignatorFireCommand_obj.Fire = Fire & 0x1;
	return SendData(&DesignatorFireCommand_obj, sizeof(DesignatorFireCommand_obj));
}


/*----- DesignatorFireReport 38451 -----*/
bool GetDesignatorFireReportFire()
{
	return DesignatorFireReport_obj.Fire;
}

bool GetDesignatorFireReportFireBlocked()
{
	return DesignatorFireReport_obj.FireBlocked;
}


/*----- DesignatorNATOCommand 8455 -----*/
int SetDesignatorNATOCommandCodeValue(uint16_t CodeValue)
{
	DesignatorNATOCommand_obj.CodeValue = CodeValue & 0xffff;
	return SendData(&DesignatorNATOCommand_obj, sizeof(DesignatorNATOCommand_obj));
}


/*----- DesignatorNATOReport 38455 -----*/
uint16_t GetDesignatorNATOReportCodeValue()
{
	return DesignatorNATOReport_obj.CodeValue;
}


/*----- IlluminatorCommand 8500 -----*/
int SetIlluminatorCommandPower(bool Power)
{
	IlluminatorCommand_obj.Power = Power & 0x1;
	return SendData(&IlluminatorCommand_obj, sizeof(IlluminatorCommand_obj));
}

int SetIlluminatorCommandArm(bool Arm)
{
	IlluminatorCommand_obj.Arm = Arm & 0x1;
	return SendData(&IlluminatorCommand_obj, sizeof(IlluminatorCommand_obj));
}


/*----- IlluminatorReport 38500 -----*/
bool GetIlluminatorReportPower()
{
	return IlluminatorReport_obj.Power;
}

bool GetIlluminatorReportArm()
{
	return IlluminatorReport_obj.Arm;
}


/*----- IlluminatorFireCommand 8501 -----*/
int SetIlluminatorFireCommandMode(int8_t Mode)
{
	IlluminatorFireCommand_obj.Mode = Mode & 0xf;
	return SendData(&IlluminatorFireCommand_obj, sizeof(IlluminatorFireCommand_obj));
}

int SetIlluminatorFireCommandFire(bool Fire)
{
	IlluminatorFireCommand_obj.Fire = Fire & 0x1;
	return SendData(&IlluminatorFireCommand_obj, sizeof(IlluminatorFireCommand_obj));
}


/*----- IlluminatorFireReport 38501 -----*/
int8_t GetIlluminatorFireReportMode()
{
	return IlluminatorFireReport_obj.Mode;
}

bool GetIlluminatorFireReportFire()
{
	return IlluminatorFireReport_obj.Fire;
}
